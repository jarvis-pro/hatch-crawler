...
// 核心引擎
export { Fetcher, type FetchResult, type FetcherOptions } from './core/fetcher';
export { UrlQueue, type QueueItem } from './core/queue';
export { BaseSpider, runSpider, type SpiderContext, type RunOptions } from './core/spider';
// scheduleOrRunOnce / ScheduleHandle 不再从入口导出：
// 当前用 pg-boss 做调度，node-cron 是 CLI 时代的实现，
...
// 解析器
export { extractNextData, buildNextDataUrl, type NextData } from './parsers/next-data-parser';
export { loadHtml, extractLinks, extractMeta, type Cheerio } from './parsers/html-parser';

// 存储抽象与默认 SQLite 实现
export type { Storage, CrawlItem, SaveItemResult } from './storage/storage';
